...
@section('title')
Add state | System Management
@endsection

@section('main')
<div class="w-full">
	<h1 class="text-xl text-gray-600">Add new state</h1>
	<div class="w-2/3 mt-16 mx-auto bg-white p-6 border rounded-lg">
		<form method="POST" action="/states" class="space-y-4">
			@csrf
			...
			<div class="space-x-4">
				<button class="px-2 py-1 text-blue-200 bg-blue-500  rounded-md font-semibold tracking-wide hover:text-blue-100 hover:bg-blue-600" type="submit">Add</button>
