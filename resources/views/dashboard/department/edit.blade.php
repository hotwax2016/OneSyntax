...
@section('title')
Edit department name | System Management
@endsection

@section('main')
<div class="w-full">
	<h1 class="text-xl text-gray-600">Edit department</h1>
		...
		<form method="POST" action="/departments/{{ $department->id }}" class="space-y-4">
			...
			<div class="flex w-full">
				<div class="flex-col w-full pr-2">
					...
					<input class="block w-full mt-1 p-2 text-gray-500 border rounded-lg shadow-sm" type="text" name="name" value="{{$department->name}}">
					@error('name')
